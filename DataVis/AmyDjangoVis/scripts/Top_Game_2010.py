...
action_2010 = vg_df[(vg_df['Year'] == 2010)]
#Identifying the top game based on global sales:
top_game_index = action_2010['Global_Sales_Million'].idxmax()
top_game = action_2010.loc[top_game_index]
...
fig = px.scatter(x=['USA', 'Europe', 'Japan', 'Other Regions'], y=region_sales, title="Regional sales for top game of 2010: " + top_game['Name'])
#add axis labels
