...
action_2016 = vg_df[(vg_df['Year'] == 2016)]
#Identifying the top game based on global sales:
top_game_index = action_2016['Global_Sales_Million'].idxmax()
top_game = action_2016.loc[top_game_index]
...
fig = px.scatter(x=['USA', 'Europe', 'Japan', 'Other Regions'], y=region_sales, title="Regional sales for top game of 2016: " + top_game['Name'])
#add axis labels
