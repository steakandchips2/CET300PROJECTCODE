...
action_2012 = vg_df[(vg_df['Year'] == 2012)]
#Identifying the top game based on global sales:
top_game_index = action_2012['Global_Sales_Million'].idxmax()
top_game = action_2012.loc[top_game_index]
...
fig = px.scatter(x=['USA', 'Europe', 'Japan', 'Other Regions'], y=region_sales, title="Regional sales for top game of 2012: " + top_game['Name'])
#add axis labels
