...
action_2015 = vg_df[(vg_df['Year'] == 2015)]
#Identifying the top game based on global sales:
top_game_index = action_2015['Global_Sales_Million'].idxmax()
top_game = action_2015.loc[top_game_index]
...
fig = px.scatter(x=['USA', 'Europe', 'Japan', 'Other Regions'], y=region_sales, title="Regional sales for top game of 2015: " + top_game['Name'])
#add axis labels
