...
save_loc = "./datavis/templates/datavis/japan/platform/jpp10_plot.html"
...
#       2010        
dfDS2010 = vg_df[(vg_df.Platform == 'DS') & (vg_df.Year == 2010) & (vg_df.JP_Sales_Million > 0)]
dfWii2010 = vg_df[(vg_df.Platform == 'Wii') & (vg_df.Year == 2010) & (vg_df.JP_Sales_Million > 0)]
dfPSP2010 = vg_df[(vg_df.Platform == 'PSP') & (vg_df.Year == 2010) & (vg_df.JP_Sales_Million > 0)]
dfPS22010 = vg_df[(vg_df.Platform == 'PS2') & (vg_df.Year == 2010) & (vg_df.JP_Sales_Million > 0)]
dfPS32010 = vg_df[(vg_df.Platform == 'PS3') & (vg_df.Year == 2010) & (vg_df.JP_Sales_Million > 0)]
dfx3602010 = vg_df[(vg_df.Platform == 'X360') & (vg_df.Year == 2010) & (vg_df.JP_Sales_Million > 0)]
dfPC2010 = vg_df[(vg_df.Platform == 'PC') & (vg_df.Year == 2010) & (vg_df.JP_Sales_Million > 0)]
...
DS2010Sales = dfDS2010['JP_Sales_Million']
...
Wii2010Sales = dfWii2010['JP_Sales_Million']
...
PSP2010Sales = dfPSP2010['JP_Sales_Million']
...
PS22010Sales = dfPS22010['JP_Sales_Million']
...
PS32010Sales = dfPS32010['JP_Sales_Million']
...
x3602010Sales = dfx3602010['JP_Sales_Million']
...
PC2010Sales = dfPC2010['JP_Sales_Million']
...
fig = px.bar(x=labels, y=sales2010, title='2010 Japan Platform sales')
